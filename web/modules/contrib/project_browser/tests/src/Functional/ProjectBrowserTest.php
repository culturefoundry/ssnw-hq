...
class ProjectBrowserTest extends BrowserTestBase {
  ...
  public function testMockPluginStatusMessage(): void {
    ...
    $assert->pageTextContains('Project Browser is currently a prototype, and the projects listed may not be up to date with Drupal.org. For the most updated list of projects, visit https://www.drupal.org/project/project_module');
