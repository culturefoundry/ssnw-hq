...
class SettingsForm extends ConfigFormBase {
   ...
   *   The route builder.
   * @param \Drupal\project_browser\Plugin\CachedDiscoveryInterface $contextualLinkManager
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['disable_add_new_module'] = [
      ...
      '#description' => $this->t('Removes access to the Drupal page that allows .tar modules to be installed, which does not use composer, so is strongly discouraged when using Project Browser.'),
    ];
