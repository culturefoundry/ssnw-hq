...
namespace Drupal\Tests\schemadotorg_recipe\Unit\Breadcrumb;
...
/**
 * @coversDefaultClass \Drupal\schemadotorg_recipe\Breadcrumb\SchemaDotOrgRecipeBreadcrumbBuilder
 * @group schemadotorg
 */
class SchemaDotOrgRecipeBreadcrumbBuilderTest extends UnitTestCase {
  ...
  /**
   * Tests SchemaDotOrgRecipeBreadcrumbBuilder::applies().
   *
   * @param bool $expected
   *   SchemaDotOrgRecipeBreadcrumbBuilder::applies() expected result.
  ...
  public function testApplies(bool $expected, ?string $route_name = NULL): void {
    $breadcrumb_builder = $this->createPartialMock('\Drupal\schemadotorg_recipe\Breadcrumb\SchemaDotOrgRecipeBreadcrumbBuilder', []);
   ...
   *   - SchemaDotOrgRecipeBreadcrumbBuilder::applies() expected result.
   *   - SchemaDotOrgRecipeBreadcrumbBuilder::applies() route name.
   */
  public function providerTestApplies(): array {
    return [
      [FALSE],
      [FALSE, 'schemadotorg_recipe'],
      [TRUE, 'schemadotorg_recipe.page'],
      [TRUE, 'schemadotorg_recipe.confirm_form'],
    ];
  }
  ...
  public function testBuild(): void {
    ...
    $route_match->method('getRouteName')
      ->willReturn('schemadotorg_recipe.confirm_form');
    $breadcrumb = $breadcrumb_builder->build($route_match);
    ...
    $expected = [
      ...
      Link::createFromRoute('Configuration', 'system.admin_config'),
      Link::createFromRoute('Schema.org', 'schemadotorg'),
      Link::createFromRoute('Recipes', 'schemadotorg_recipe.overview'),
    ];
    $this->assertEquals($expected, $breadcrumb->getLinks());
  }
